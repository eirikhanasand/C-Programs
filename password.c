...
int main() {
   ...
   int uLetter = 0;                 // number of upper case letters
   int lLetter = 0;                 // number of lowercase letters
   int sign = 0;                    // number of other characters
   int legal =  0;                  // if password is legal
   int illegal = 0;                 // how many illegal characters in password
   int pChar = 0;                   // Character when encrypting
   int matchingUser = 0;            // Matching user when logging in
   int loggedin = 0;                // True false for logged in status
