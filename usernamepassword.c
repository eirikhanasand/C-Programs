...
char* encode(char string[STRLEN]);           //Function for encrypting password

/**
  Main program that takes username and password. Also uses encrypt function to encrypt password
 */
int main() {
