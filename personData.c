...
#include "personData.h"   //Included for struct and other include files

const int MAXPEOPLE = 10; //Max amount of people
Person person[10];        //Struct for storing info about the user

/**
 Main functions that takes name age and height for n < const maxpeople.
 Prints total age, avg weight and oldest person. Can also print every person in order.
 */
int main(){
    int howMany = 0;
    int totalAge = 0;
